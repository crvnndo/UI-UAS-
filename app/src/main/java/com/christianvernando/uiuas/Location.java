...
public class Location extends AppCompatActivity implements OnMapReadyCallback, MapboxMap.OnMapClickListener, PermissionsListener {
        ...
        searchfab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new PlaceAutocomplete.IntentBuilder()
                        ...
                        .build(com.filbertfilbert.uts.Location.this);
    ...
    public void onMapReady(@NonNull final MapboxMap mapboxMap) {
        ...
        mapboxMap.setStyle(getString(R.string.navigation_guidance_day), new Style.OnStyleLoaded() {
            ...
            public void onStyleLoaded(@NonNull Style style) {
                ...
                mapboxMap.addOnMapClickListener(com.filbertfilbert.uts.Location.this);
...
// Call this method with Context from within an Activity
                        NavigationLauncher.startNavigation(com.filbertfilbert.uts.Location.this, options);
                    }
                });
            }
        });
